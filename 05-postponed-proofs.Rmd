...
**Proof of Theorem \@ref(thm:dynkin)**
...
**Proof of Lemma \@ref(lem:caratheodory)**
...
**Proof of Lemma \@ref(lem:premeasure)**
...
**Proof of Theorem \@ref(thm:radonnikodym)**
...
**Proof of Example \@ref(exm:2dimborel)**
First, we show
...
**Proof of Lemma \@ref(lem:sectionprop)**
...
**Proof of Lemma \@ref(lem:measurefn)**
...
have $$\label{eq:prodaux}
\nu((A \times B)_x) = \nu(B) \dsone_A(x),$$ which implies that
...
**Proof of Theorem \@ref(thm:prodmeasure)**
