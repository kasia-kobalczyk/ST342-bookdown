...
::: {.definition name="Infinitely often and eventually"}
...
::: {.proof}
We look instead at $\{A_n \ \text{i.o.}\}^c$. By
Remark [\[rmk:limcomplement\]](#rmk:limcomplement){reference-type="ref"
reference="rmk:limcomplement"}, continuity from below and from above,
