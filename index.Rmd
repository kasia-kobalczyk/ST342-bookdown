--- 
title: "Probability with Elementary Measure Theory"
...
description: "These are the lecture notes for the ST342 Mathematics of Random Events module taught at the University of Warwick in the academic year of 2021/2022."
---
...
```{r, fig.alt="Creative Commons Attribution-ShareAlike license", fig.align='center', echo=FALSE, out.width="30%"}
...
The source code of the current version can be found at  

[https://github.com/Kaasiak/ST342-bookdown](https://github.com/Kaasiak/ST342-bookdown){target="_blank" rel="noopener noreferrer nofollow"}
